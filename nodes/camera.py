...
from message import CompressedImage, ProcessedData
...
class Node:
    ...
    def run(self):
        while True:
            ...
            image_data = ProcessedData(0, 0, 0, 0, 0, 0)
            ...
            image_data.pos_intersection = int(pos_intersection)
            ...
            # =======================
            self.processed_image_data.put(ProcessedData.serialize(image_data))
